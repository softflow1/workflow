package com.activitiweb.controller;

import com.activitiweb.pojo.UserInfoBean;
import com.activitiweb.util.AjaxResponse;
import com.activitiweb.util.GlobalConfig;
import com.activitiweb.SecurityUtil;
                ...
                for (FlowElement flowElement : flowElements) {
                    ...
                    if (flowElement instanceof UserTask) {
                        ...
                        if (userTask.getId().equals(s.getActivityId())) {
                            ...
                            //因为高亮连线查询的是所有节点 两两组合把待办之后往外发出的连线也包含进去了，所以要把高亮待办节点之后即出的连线去掉
